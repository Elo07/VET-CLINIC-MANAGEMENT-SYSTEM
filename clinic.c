...
void editPatient(struct Patient patient[], int max)
{
    ...
    {
        index = findPatientIndexByPatientNum(patientNo, patient, max);
...
{
    int i, nextPatientNo, maxPatientNumber = patient[0].patientNumber;
    ...
    nextPatientNo = maxPatientNumber + 1;
